...
export default function Service_details_page_four() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle= {t('monitoringAndSupport')} >
                                ...
                                <div className="sidebar-widget category-widget">
                                    ...
                                    <div className="widget-content">
                                        <ul className="category-list clearfix">
                                            ...
                                            <li><Link href="/service-details-2"><span>{t('tradingAccount')}</span><i className="flaticon-right-arrow-1"></i></Link></li>
                                            <li><Link href="/service-details-3"><span>{t('platformsAndTools')}</span><i className="flaticon-right-arrow-1"></i></Link></li>
                                            <li><Link href="/service-details-4" className="current"><span>{t('monitoringAndSupport')}</span><i className="flaticon-right-arrow-1"></i></Link></li>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div className="account-details-content">
                                <div className="content-one">
                                    <h2>{t("serviceD4.content1.title")}</h2>
                                    <p>
                                    {t("serviceD4.content1.description")} 
                                    </p>
                                    <figure className="image-box"><img src="../assets/images/resource/account-6.jpg" alt=""/></figure>
                                </div>
                                <div className="content-two">
                                    <div className="text-box">
                                        <h2>{t("serviceD4.content2.title")}</h2>
                                        <p>
                                        {t("serviceD4.content2.description")}
                                        </p>
                                    </div>
                                    <div className="row clearfix">
