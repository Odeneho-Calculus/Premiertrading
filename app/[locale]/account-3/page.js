...
export default function Account_three() {
                                ...
                                <div className="sidebar-widget category-widget">
                                    ...
                                    <div className="widget-content">
                                        <ul className="category-list clearfix">
                                            ...
                                            <li><Link href="/account-3" className="current"><span>Individual Account</span><i className="flaticon-right-arrow-1"></i></Link></li>
