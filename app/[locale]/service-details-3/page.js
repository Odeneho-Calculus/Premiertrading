...
export default function Service_details_page_three() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle= {t('platformsAndTools')} >
                                ...
                                <div className="sidebar-widget category-widget">
                                    ...
                                    <div className="widget-content">
                                        <ul className="category-list clearfix">
                                            ...
                                            <li><Link href="/service-details-3" className="current"><span>{t('platformsAndTools')}</span><i className="flaticon-right-arrow-1"></i></Link></li>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div className="account-details-content">
                                <div className="content-one">
                                    <h2>{t('introducingPlatforms')}</h2>
                                    <p>{t('introText')}</p>
                                    <figure className="image-box"><img src="../assets/images/resource/account-7.jpg" alt=""/></figure>
                                </div>
